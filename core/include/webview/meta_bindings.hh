...
inline std::vector<std::string> parse_json_array(const std::string& json) {
...
inline void setup_meta_bindings(meta_runtime& runtime, std::function<void(const std::string&, std::function<void(const std::string&, const std::string&, void*)>, void*)> bind_fn) {
    bind_fn("__meta_spawn", [&runtime](const std::string& /*id*/, const std::string& req, void* /*arg*/) {
        ...
        std::vector<std::string> cmd = parse_json_array(cmd_json);
        spawn_options opts;
    ...
    bind_fn("__meta_spawnSync", [&runtime](const std::string& /*id*/, const std::string& req, void* /*arg*/) {
...
#endif // WEBVIEW_META_BINDINGS_HH
