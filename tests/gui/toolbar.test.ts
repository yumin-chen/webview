...
import { Toolbar, createComponent, updateComponent, destroyComponent } from "../../src/gui";
...
describe("Alloy:gui > Toolbar", () => {
  test("creation with props", () => {
    const props = { children: [] };
    const element = Toolbar(props);
    expect(element.type).toBe("Toolbar");
