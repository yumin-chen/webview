...
import { Tooltip, createComponent, updateComponent, destroyComponent } from "../../src/gui";
...
describe("Alloy:gui > Tooltip", () => {
  test("creation with props", () => {
    const props = { text: 'Help' };
    const element = Tooltip(props);
