...
import { MenuBar, createComponent, updateComponent, destroyComponent } from "../../src/gui";
...
describe("Alloy:gui > MenuBar", () => {
  test("creation with props", () => {
    const props = { children: [] };
    const element = MenuBar(props);
    expect(element.type).toBe("MenuBar");
