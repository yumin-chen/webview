...
import { ContextMenu, createComponent, updateComponent, destroyComponent } from "../../src/gui";
...
describe("Alloy:gui > ContextMenu", () => {
  test("creation with props", () => {
    const props = { children: [] };
    const element = ContextMenu(props);
    expect(element.type).toBe("ContextMenu");
